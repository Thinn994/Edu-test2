...
## 1. Introduction
*Author: Nguyễn Xuân Hoàng, Reviewer: Lê Quí Thịnh, Editor: Nguyễn Xuân Hoàng*[cite: 5]
...
* **Goals:** To build a centralized classroom management platform that supports document storage, real-time communication, and progress tracking[cite: 5]. Additionally, the project aims to reduce teacher workload through automated quiz generation and to support students with AI-driven material explanations and deadline reminders.
...
Due to the learning objectives of this course, all students must act as full-stack engineers[cite: 5]. However, to ensure smooth collaboration and accountability, primary roles have been assigned:
...
| :--- | :--- | :--- |
| **Technology Issues (AI Integration Complexity)**[cite: 5] | AI-generated quizzes or explanations may suffer from hallucinations or high API latency, affecting user trust. | Conduct spike research early in Sprint 2. Build strict prompt templates and allow teachers to manually review and edit AI-generated quizzes before publishing. |
| **Scope Creep**[cite: 5] | Attempting to build real-time messaging, file management, and multiple AI features may lead to missed deadlines. | Prioritize the Minimum Viable Product (MVP) for core LMS features and one primary AI feature (Auto-Quiz) first. Delay secondary features (messaging) to Sprints 4 or 5 if time permits. |
| **Member Unavailability**[cite: 5] | Loss of team members or absences can overload the remaining developers, especially for complex modules. | Hold regular Scrum meetings and maintain transparent task tracking on Jira. Ensure all code is well-commented and documented for easy handover. |

## 4. Project Plan
*Author: Nguyễn Xuân Hoàng, Reviewer: Lê Quí Thịnh, Editor: Nguyễn Xuân Hoàng*[cite: 5]

This project strictly follows the Scrum process[cite: 5]. The development lifecycle is divided into 5 Sprints, each corresponding to one Project Assignment (PA) and lasting approximately 2-3 weeks[cite: 5]. 

### 4.1 Schedule
* **Sprint 1 (PA1):** Team formation, Existing App Survey, Project Proposal, and Team Contract setup.
* **Sprint 2 (PA2 - Current):** Draft Project Plan and Vision Document, initialize Spec Kit, and set up the Jira task board[cite: 5].
...
*(Note: For Sprints 3, 4, and 5, detailed tasks will be created and assigned during the Sprint Planning meeting at the beginning of each respective sprint[cite: 5].)*
...
* **Build 3 - Final Build (Sprint 5):** Code freeze. Stable version containing all refined features, including the academic warning system, ready for the final demo[cite: 5].